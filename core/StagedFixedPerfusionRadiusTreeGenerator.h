...
#ifndef STAGEDFIXEDPERFUSIONRADIUSTREEGENERATOR_H_
#define STAGEDFIXEDPERFUSIONRADIUSTREEGENERATOR_H_
 ...
 */
class StagedFixedPerfusionRadiusTreeGenerator : public IDomainObserver {
...
public:
	 ...
	 */
	StagedFixedPerfusionRadiusTreeGenerator(StagedDomain *domain, point xi, double rootRadii, double qi, long long int nTerm, vector<AbstractConstraintFunction<double,int> *>gam, vector<AbstractConstraintFunction<double,int> *>epsLim, vector<AbstractConstraintFunction<double,int> *>nu, double minAngle, double refPressure);
	/**
	 ...
	 */
	StagedFixedPerfusionRadiusTreeGenerator(StagedDomain *domain, point xi, double rootRadii, double qi, long long int nTerm, vector<AbstractConstraintFunction<double,int> *>gam, vector<AbstractConstraintFunction<double,int> *>epsLim, vector<AbstractConstraintFunction<double,int> *>nu, double minAngle, double refPressure, double viscosityTolerance, int optimized);
	/**
	 ...
	 * @param nu		Viscosity function.
	 */
	StagedFixedPerfusionRadiusTreeGenerator(StagedDomain *domain, AbstractStructuredCCOTree *tree, long long int nTerm, vector<AbstractConstraintFunction<double,int> *>gam, vector<AbstractConstraintFunction<double,int> *>epsLim, vector<AbstractConstraintFunction<double,int> *>nu);
	/**
...
#endif /* FIXEDPERFUSIONRADIUSTREEGENERATOR_H_ */
