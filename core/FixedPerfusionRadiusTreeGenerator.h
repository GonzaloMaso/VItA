...
#ifndef FIXEDPERFUSIONRADIUSTREEGENERATOR_H_
#define FIXEDPERFUSIONRADIUSTREEGENERATOR_H_
 ...
 */
class FixedPerfusionRadiusTreeGenerator : public IDomainObserver {
...
public:
	 ...
	 */
	FixedPerfusionRadiusTreeGenerator(AbstractDomain *domain, point xi, double rootRadii, double qi, long long int nTerm, AbstractConstraintFunction<double,int> *gam, AbstractConstraintFunction<double,int> *epsLim, AbstractConstraintFunction<double,int> *nu, double minAngle, double refPressure);
	/**
	 ...
	 * @param nu		Viscosity function.
	 */
	FixedPerfusionRadiusTreeGenerator(AbstractDomain *domain, AbstractStructuredCCOTree *tree, long long int nTerm, AbstractConstraintFunction<double,int> *gam, AbstractConstraintFunction<double,int> *epsLim, AbstractConstraintFunction<double,int> *nu);
	/**
