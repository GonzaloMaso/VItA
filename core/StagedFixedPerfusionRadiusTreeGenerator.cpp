...
StagedFixedPerfusionRadiusTreeGenerator::StagedFixedPerfusionRadiusTreeGenerator(
...
AbstractStructuredCCOTree *StagedFixedPerfusionRadiusTreeGenerator::generate() {
...
int StagedFixedPerfusionRadiusTreeGenerator::isValidRootSegment(point xNew,
		int iTry) {
...
int StagedFixedPerfusionRadiusTreeGenerator::isValidSegment(point xNew, int iTry) {
...
StagedDomain * StagedFixedPerfusionRadiusTreeGenerator::getDomain() {
	return domain;
}

vector<AbstractStructuredCCOTree*> StagedFixedPerfusionRadiusTreeGenerator::getTrees() {
	vector<AbstractStructuredCCOTree*> trees;
	trees.push_back(tree);
	return trees;
}

void StagedFixedPerfusionRadiusTreeGenerator::enableConfigurationFile(
		string filename) {
	this->isGeneratingConfFile = 1;
	this->confFilename = filename;
}

void StagedFixedPerfusionRadiusTreeGenerator::generatesConfigurationFile(ios::openmode mode) {
...
void StagedFixedPerfusionRadiusTreeGenerator::markTimestampOnConfigurationFile(
		string label) {
	if (isGeneratingConfFile) {
...
void StagedFixedPerfusionRadiusTreeGenerator::closeConfigurationFile() {
...
AbstractStructuredCCOTree* StagedFixedPerfusionRadiusTreeGenerator::resume() {
...
void StagedFixedPerfusionRadiusTreeGenerator::observableModified(IDomainObservable* observableInstance) {
